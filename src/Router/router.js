          ...
          <section id="content">
            <section className="vbox">
              ...
              <section className="scrollable">
                ...
                <Route
                  exact
                  path="/business/pages/create"
                  component={requireAuth(BusinessCD)}
                />
                <Route
                  path="/business/view/:id"
                  component={requireAuth(ClientView)}
                />
                <Route
                  excat
                  path="/business/pages/mySchedule/:id"
                ...
                <Route
                  ...
                  component={requireAuth(NewAppointment)}
                />
              </section>
            </section>
          </section>
