					...
					<GridItem xs={12} sm={6} md={5} lg={5}>
						...
						<Card>
							...
							<CardHeader className={`${classes.cardHeader} ${classes.textCenter}`}>
								<h3 className={`${classes.cardTitle} text-muted`}>Set appointment</h3>
							</CardHeader>{' '}
							<CardBody>
								{(() => {
												...
												<GridItem xs={12}>
													<Grid container direction="row" justify="center">
														<small className={'text-muted'}>
															Please choose services: (multiple options is available)
														</small>
													</Grid>
													<SelectServices
														values={this.state}
													...
													<Grid container direction="row" justify="center">
														<Warning>
															the page will load as soon as u choose the service
														</Warning>
													</Grid>
												</GridItem>
											);
										case 1:
											return (
												<GridItem xs={12}>
													<Grid container direction="row" justify="center">
														<small className={'text-muted'}>
															Please choose services: (you can still change it)
														</small>
													</Grid>
													<SelectServices
														values={this.state}
													...
													<Grid container direction="row" justify="center">
														<Warning>Hint, There is no right answer, :)</Warning>
													</Grid>
												</GridItem>
											);
										...
										case 2:
											return (
												<GridItem xs={12}>
													...
													<Grid container direction="row" justify="center">
														<small className={'text-muted'}>
															<Success>Relax we did all the work,</Success>
														</small>
													</Grid>
													<Grid container direction="row" justify="center">
														<small className={'text-muted'}>
															just click what time most comfortable for you
														</small>
													</Grid>
													<SmartOutPut
														values={this.state}
													...
													/>
													<Grid container direction="row" justify="center">
														<Warning>You can always change the fields :)</Warning>
													</Grid>
												</GridItem>
											);
										default:
...
export default connect(mapStatetoProps, { getBusinessById, setFlashMessage })(
