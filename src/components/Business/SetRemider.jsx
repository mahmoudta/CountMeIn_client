...
class SetRemider extends Component {
	...
	setReminder = (e) => {
		...
		const tmpServices = this.state.selectedOptions.map((service) => {
					...
					<GridItem xs={12} sm={6} md={5} lg={5}>
						...
						<Card login>
							...
							<CardHeader className={`${classes.cardHeader} ${classes.textCenter}`}>
								<h3 className={`${classes.cardTitle} text-muted`}>Set reminder</h3>
							</CardHeader>{' '}
							<CardBody>
								<GridItem xs={12}>
									...
									<div className="row">
										<div className="form-group col-6">
											<Select
												defaultValue={this.state.daysOptions[0]}
										...
										<div className="form-group col-6">
											<Select
												defaultValue={this.state.monthsOptions[0]}
								...
								{this.state.allFilled ? (
									<Grid container direction="row" justify="center">
										{' '}
										<Button color="success" size="md" onClick={() => this.setReminder()}>
											Set Reminder
										</Button>
									</Grid>
								) : (
									<Grid container direction="row" justify="center">
										...
										<Success>
											By setting reminder , we will be able to suggest to you the correct
											appointment with the most ideal time for you ,
										</Success>
									</Grid>
								)}
							</CardBody>
...
export default connect(mapStatetoProps, { setFlashMessage, getBusinessById })(withStyles(loginPageStyle)(SetRemider));
