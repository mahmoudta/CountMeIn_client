...
export class TodaysPanel extends Component {
	...
	render() {
		...
		return PannelStats ? (
			<GridContainer
				className="d-flex justify-content-between cont"
				style={{
					maxHeight : '175px',
					overflowX : 'auto',
					overflowY : 'none'
								...
								<div className="card-body">
									<div className="row no-gutters align-items-center">
										...
										<div className="col mr-2">
											...
											<div className="">{PannelStats.All} Appointments</div>
										</div>
									</div>
								</div>
							</Card>
								...
								<div className="card-body">
									<div className="row no-gutters align-items-center">
										...
										<div className="col mr-2">
											...
											<div className="">{PannelStats.Done} Appointments</div>
										</div>
									</div>
								</div>
							</Card>
								...
								<div className="card-body">
									<div className="row no-gutters align-items-center">
										...
										<div className="col mr-2">
											...
											<div>{PannelStats.upcomming} Appointments</div>
										</div>
									</div>
								</div>
							</Card>
